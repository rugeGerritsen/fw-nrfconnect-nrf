...
#define MASTER_MEM_SIZE BLE_CONTROLLER_MEM_PER_MASTER_LINK(CONFIG_BT_CTLR_DATA_LENGTH_MAX,  \
							   CONFIG_BT_CTLR_DATA_LENGTH_MAX,  \
							   BLE_CONTROLLER_DEFAULT_TX_PACKET_COUNT, \
							   BLE_CONTROLLER_DEFAULT_RX_PACKET_COUNT)

#define SLAVE_MEM_SIZE  BLE_CONTROLLER_MEM_PER_SLAVE_LINK(CONFIG_BT_CTLR_DATA_LENGTH_MAX,  \
							  CONFIG_BT_CTLR_DATA_LENGTH_MAX,  \
							  BLE_CONTROLLER_DEFAULT_TX_PACKET_COUNT, \
							  BLE_CONTROLLER_DEFAULT_RX_PACKET_COUNT)

#define ROLE_MEM_MAX    MAX(MASTER_MEM_SIZE, SLAVE_MEM_SIZE)

static u8_t ble_controller_mempool[ROLE_MEM_MAX * CONFIG_BT_MAX_CONN];
